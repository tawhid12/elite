...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->string('bn_parm_post_ofc')->nullable();
            $table->string('bn_parm_phone_my')->nullable();
            $table->string('bn_parm_phone_alt')->nullable();
            $table->string('bn_pre_district_id')->nullable();
            $table->string('bn_pre_upazila_id')->nullable();
            $table->string('bn_pre_union_id')->nullable();
            $table->string('bn_pre_ward_no')->nullable();
            $table->string('bn_pre_holding_no')->nullable();
            $table->string('bn_pre_village_name')->nullable();
            $table->string('bn_pre_post_ofc')->nullable();
            $table->string('bn_identification_mark')->nullable();
            $table->string('bn_edu_qualification')->nullable();
            $table->string('bn_blood_id')->nullable();
            $table->string('bn_dob')->nullable();
            $table->string('bn_age')->nullable();
